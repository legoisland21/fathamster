...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	Texture2D floor = LoadTexture("stuff.jpg");
	Texture2D player = LoadTexture("robin.png");
	InitAudioDevice();
	Sound cheatOn = LoadSound("cheatstart.wav");
	Sound cheatOff = LoadSound("cheatstop.wav");
